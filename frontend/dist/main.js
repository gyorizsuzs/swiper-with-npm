      ...
      379: (e) => {
        ...
        e.exports = function (e, r) {
          ...
          return function (e) {
            ...
            for (var l = i(e, r), d = 0; d < n.length; d++) {
              var c = s(n[d]);
    ...
    (() => {
      ...
      const h = {
        ...
        on: function (...e) {
          ...
          function n(e) {
            ...
            if ((r.indexOf(e) < 0 && r.unshift(e), c(t).is(s))) i.apply(t, r);
            else {
              const e = c(t).parents();
              for (let t = 0; t < e.length; t += 1)
                c(e[t]).is(s) && i.apply(e[t], r);
            }
          }
          function a(e) {
            ...
            for (let t = 0, r = s.length; t < r; t += 1) {
              ...
              void 0 !== n &&
                ...
                (v(e[r]) && v(i[r])
                  ...
                  : !v(e[r]) && v(i[r])
                  ? ((e[r] = {}),
                    i[r].__swiper__ ? (e[r] = i[r]) : A(e[r], i[r]))
                  : (e[r] = i[r]));
            }
          }
        }
        ...
        M = {
          ...
          updateSlides: function () {
            ...
            for (let r = 0; r < p; r += 1) {
              ...
              if (
                ...
                if ('auto' === i.slidesPerView) {
                  ...
                  (C = (n - (i.slidesPerView - 1) * A) / i.slidesPerView),
                    i.roundLengths && (C = Math.floor(C)),
                    c[r] && (c[r].style[t('width')] = `${C}px`);
                c[r] && (c[r].swiperSlideSize = C),
                  f.push(C),
                  i.centeredSlides
                    ? ((T = T + C / 2 + S / 2 + A),
                      0 === S && 0 !== r && (T = T - n / 2 - A),
            ...
            if (
              ...
              (u = t),
                Math.floor(e.virtualSize - n) - Math.floor(u[u.length - 1]) >
                  1 && u.push(e.virtualSize - n);
            }
          ...
          if (o.cssMode) {
            ...
            if (0 === t) {
              ...
              if (!n.support.smoothScroll)
                return (
                  T({ swiper: n, targetPosition: s, side: e ? 'left' : 'top' }),
                  !0
                );
      ...
      function k(e) {
        ...
        const m = l.currentX,
          ...
          A = o.edgeSwipeThreshold || o.iOSEdgeSwipeThreshold;
        ...
        if (
          ...
          p.is(n.focusableElements) &&
            ...
            s.activeElement &&
              f(s.activeElement).is(n.focusableElements) &&
              s.activeElement !== p[0] &&
        ...
        Y = {
          attachEvents: function () {
            ...
            (e.onTouchStart = k.bind(e)),
              ...
              (e.onClick = I.bind(e)),
              i.touch && !D && (t.addEventListener('touchstart', $), (D = !0)),
              N(e, 'on');
          },
      ...
      const R = {
          ...
          loop: {
            loopCreate: function () {
              const e = this,
                ...
                n = i.children().length > 0 ? f(i.children()[0].parentNode) : i;
              ...
              for (let e = 0; e < l.length; e += 1)
                n.append(f(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
              for (let e = o.length - 1; e >= 0; e -= 1)
                n.prepend(
                  f(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass)
                );
            },
            loopFix: function () {
              const e = this;
          ...
          images: {
            loadImage: function (e, t, s, i, r, n) {
              ...
              f(e).parent('picture')[0] || (e.complete && r)
                ? d()
                : t
                ? ((l = new o.Image()),
                  (l.onload = d),
      ...
      (oe.styleTagTransform = ne()),
        (oe.setAttributes = te()),
        (oe.insert = J().bind(null, 'head')),
        (oe.domAPI = U()),
        (oe.insertStyleElement = ie()),
        Q()(ae.Z, oe),
        ae.Z && ae.Z.locals && ae.Z.locals,
        window.addEventListener('load', async () => {
          console.log('loaded');
          const e = await le('/images');
          console.log(e),
            document
              .getElementById('root')
              .insertAdjacentHTML('beforeend', ce(e, de)),
            new q('.swiper', { loop: !0 });
        });
      const le = async (e) => (await fetch(e)).json(),
        de = (e) =>
          `\n        <div class="swiper-slide">\n            <h2>${e.title}<h2>\n            <image src="public/${e.url}">\n        </div>\n    `,
        ce = (e, t) =>
